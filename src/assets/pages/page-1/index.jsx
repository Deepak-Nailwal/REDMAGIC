...
//  <img className="img-fluid w-25" src={img1} alt="img" />                 
//                     <img className="img-fluid w-25" src={img2} alt="img" />
//                     <img className="img-fluid w-25" src={img3} alt="img" />
//                     <img className="img-fluid w-25" src={img4} alt="img" />